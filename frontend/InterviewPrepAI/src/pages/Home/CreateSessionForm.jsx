  ...
  const handleCreateSession = async (e) => {
    ...
    try{
      ...
      const response = await axiosInstance.post(API_PATHS.SESSION.CREATE, {
        ...formData,
        topicsToFocus: formData.topicsToFocus, // for backend compatibility
        question: generatedQuestions,         // backend expects 'question', not 'questions'
      });
  ...
  return (
    <>
      <LoadingModal 
        ...
        estimatedTime="This typically takes 10-15 seconds"
        type="question-generation"
      />
      <div className="w-full max-w-lg mx-auto p-4 flex flex-col justify-center min-w-0">
        ...
        <form onSubmit={handleCreateSession} className="flex flex-col gap-3">
          ...
          >
            {isLoading ? 'Generating Questions...' : 'Create Session'}
          </button>
        </form>
      </div>
    </>
